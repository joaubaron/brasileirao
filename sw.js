const CACHE_VERSION = '05.05.2026-1032';
...
self.addEventListener('fetch', e => {
  ...
  // 🚫 NÃO CACHEAR API DO FLUMINENSE (worker externo)
  if (e.request.url.includes('workers.dev') || e.request.url.includes('/fluminense')) {
